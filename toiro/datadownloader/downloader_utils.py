...
_RESOURCE_DIR = os.getenv(f"{_LIB_NAME}",
                          os.path.join(_HOME_DIR, f'{_LIB_NAME}_resources'))
...
_CORPORA_DICT = {
    ...
    "yahoo_movie_reviews": {
        "url":
        "https://media.githubusercontent.com/media/dennybritz/sentiment-analysis/master/data/yahoo-movie-reviews.json.tar.gz",
